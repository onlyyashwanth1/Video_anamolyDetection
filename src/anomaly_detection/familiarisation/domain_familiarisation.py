...
def caption_event(
    ...
    GEMINI_API_KEY or GOOGLE_API_KEY is available, otherwise falls back to
        ...
        try:
            ...
            target_frame = (
                ...
                if (0 <= mid_idx < len(raw_frames))
                    ...
                    (f for f in raw_frames if f.frame_number == mid_idx),
                    None,
                )
            )
            ...
            if target_frame is not None:
                ...
                prompt = (
                    "Describe the main action or activity occurring in this "
                    "video frame concisely in one short, plain-English sentence."
                )
